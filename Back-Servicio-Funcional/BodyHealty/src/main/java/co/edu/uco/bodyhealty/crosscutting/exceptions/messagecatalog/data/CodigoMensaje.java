...
import static co.edu.uco.bodyhealty.crosscutting.helpers.TextHelper.UNDERLINE;
import static co.edu.uco.bodyhealty.crosscutting.helpers.TextHelper.concatenate;
...
public enum CodigoMensaje {
	...
	M00028(TipoMensaje.USUARIO, CategoriaMensaje.ERROR, "00028", false),
	...
	M00024(TipoMensaje.TECNICO, CategoriaMensaje.EXITO, "00024", true),
	M00039(TipoMensaje.USUARIO, CategoriaMensaje.EXITO, "00039", true),
	...
	M00043(TipoMensaje.USUARIO, CategoriaMensaje.EXITO, "00043", false),
