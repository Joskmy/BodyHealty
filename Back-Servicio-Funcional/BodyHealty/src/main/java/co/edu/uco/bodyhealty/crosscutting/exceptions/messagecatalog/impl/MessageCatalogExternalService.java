...
public final class MessageCatalogExternalService implements MessageCatalog {
	...
	public final void inicializar() {
		...
		mensajes.put(CodigoMensaje.M00024.getIdentificador(),
				new Mensaje(CodigoMensaje.M00024, "Se ha presentado un problema INESPERADO tratando de realizar un insert de la información del país \\\"${1}\\\" en la tabla \"Servicio\" de la base de datos PostgreSQL..."));
		...
		mensajes.put(CodigoMensaje.M00029.getIdentificador(),
				new Mensaje(CodigoMensaje.M00029, "Se ha presentado un problema ejecutando la sentencia SQL de consulta de los servicios en la base de datos PostgreSQL."));
		mensajes.put(CodigoMensaje.M00043.getIdentificador(),
				new Mensaje(CodigoMensaje.M00043, "Ya existe un servicio con el nombre asociado al Servicio deseado..."));
	}
