...
public class CitaEntityDomainAssembler implements EntityDomainAssembler<CitaDomain, CitaEntity> {
    ...
    public final CitaDomain ensamblarDominio(final CitaEntity entidad) {
        ...
        return CitaDomain.crear(citaEntityTmp.getId(), pacienteDominio, turnoDominio, servicioDominio, cubiculoDominio,estadoCitaDominio);
    }
    ...
    public final CitaEntity ensablarEntidad(final CitaDomain dominio) {
        ...
        var cubiculoEntity = cubiculoAssembler.ensablarEntidad(citaDomainTmp.getCubiculo());

        return CitaEntity.build(citaDomainTmp.getId(), pacienteEntity, turnoEntity, servicioEntity, cubiculoEntity ,estadoCitaEntity);
    }
