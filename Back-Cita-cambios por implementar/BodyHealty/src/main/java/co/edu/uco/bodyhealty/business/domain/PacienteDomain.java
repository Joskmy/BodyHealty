...
public class PacienteDomain {
	...
	public PacienteDomain(final int id, final TipoDocumentoDomain tipoId, final int numeroDocumento,
	...
	public static final PacienteDomain crear() {
		return new PacienteDomain();
	}

	public static final PacienteDomain crear(final int id, final TipoDocumentoDomain tipoId, final int numeroDocumento,
			final String primerNombre, final String segundoNombre, final String primerApellido,
			final String segundoApellido, final String correoElectronico, final String telefono, final String cuenta,
			final String contrasenia) {
		return new PacienteDomain(id, tipoId, numeroDocumento, primerNombre, segundoNombre, primerApellido,
				segundoApellido, correoElectronico, telefono, cuenta, contrasenia);
	}
