...
public class TurnoDTODomainAssembler implements DTODomainAssembler<TurnoDomain, TurnoDTO> {
    ...
    private static final DTODomainAssembler<TurnoDomain, TurnoDTO> instancia = new TurnoDTODomainAssembler();
    ...
    public static final DTODomainAssembler<TurnoDomain, TurnoDTO> obtenerInstancia() {
        return instancia;
    }
