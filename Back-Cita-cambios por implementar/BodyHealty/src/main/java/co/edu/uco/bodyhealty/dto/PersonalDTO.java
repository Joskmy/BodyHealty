...
public final class PersonalDTO {
	...
	public PersonalDTO(final int id, final TipoDocumentoDTO tipoId, final int numeroDocumento,
	...
	public final PersonalDTO setId(final int id) {
		this.id = id;
		return this;
	}

	public final PersonalDTO setTipoId(final TipoDocumentoDTO tipoId) {
		this.tipoId = ObjectHelper.getObjectHelper().getDefault(tipoId, TipoDocumentoDTO.build());
		return this;
	}

	public final PersonalDTO setNumeroDocumento(final int numeroDocumento) {
		this.numeroDocumento = numeroDocumento;
		return this;
	}
	
	public final PersonalDTO setPrimerNombre(final String primerNombre) {
		this.primerNombre = TextHelper.applyTrim(primerNombre);
		return this;
	}

	public final PersonalDTO setSegundoNombre(final String segundoNombre) {
		this.segundoNombre = TextHelper.applyTrim(segundoNombre);
		return this;
	}

	public final PersonalDTO setPrimerApellido(final String primerApellido) {
		this.primerApellido = TextHelper.applyTrim(primerApellido);
		return this;
	}

	public final PersonalDTO setSegundoApellido(final String segundoApellido) {
		this.segundoApellido = TextHelper.applyTrim(segundoApellido);
		return this;
	}

	public final PersonalDTO setCorreoElectronico(final String correoElectronico) {
		this.correoElectronico = TextHelper.applyTrim(correoElectronico);
		return this;
	}

	public final PersonalDTO setTelefono(final String telefono) {
		this.telefono = TextHelper.applyTrim(telefono);
		return this;
	}

	public final PersonalDTO setCuenta(final String cuenta) {
		this.cuenta = TextHelper.applyTrim(cuenta);
		return this;
	}

	public final PersonalDTO setContrasenia(final String contrasenia) {
