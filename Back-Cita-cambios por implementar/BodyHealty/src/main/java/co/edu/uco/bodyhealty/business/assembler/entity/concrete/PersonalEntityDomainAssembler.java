...
public class PersonalEntityDomainAssembler implements EntityDomainAssembler<PersonalDomain, PersonalEntity> {
    ...
    public final PersonalDomain ensamblarDominio(final PersonalEntity entidad) {
        ...
        var tipoDocumentoDominio = tipoDocumentoAssembler.ensamblarDominio(personalEntityTmp.getTipoId());
        return PersonalDomain.crear(personalEntityTmp.getId(), tipoDocumentoDominio, personalEntityTmp.getNumeroDocumento(),
                personalEntityTmp.getPrimerNombre(), personalEntityTmp.getSegundoNombre(), personalEntityTmp.getPrimerApellido(),
                personalEntityTmp.getSegundoApellido(), personalEntityTmp.getCorreoElectronico(), personalEntityTmp.getTelefono(),
                personalEntityTmp.getCuenta(), personalEntityTmp.getContrasenia());
    }
    ...
    public final PersonalEntity ensablarEntidad(final PersonalDomain dominio) {
        ...
        var tipoDocumentoEntity = tipoDocumentoAssembler.ensablarEntidad(personalDomainTmp.getTipoId());
        return PersonalEntity.build(personalDomainTmp.getId(), tipoDocumentoEntity, personalDomainTmp.getNumeroDocumento(),
                personalDomainTmp.getPrimerNombre(), personalDomainTmp.getSegundoNombre(), personalDomainTmp.getPrimerApellido(),
                personalDomainTmp.getSegundoApellido(), personalDomainTmp.getCorreoElectronico(), personalDomainTmp.getTelefono(),
                personalDomainTmp.getCuenta(), personalDomainTmp.getContrasenia());
    }
